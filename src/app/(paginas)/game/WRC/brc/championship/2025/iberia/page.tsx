...
import ss1 from "@/data/constants/WRC/brc/2025/iberia/SS1";
import ss2 from "@/data/constants/WRC/brc/2025/iberia/SS2";
import ss3 from "@/data/constants/WRC/brc/2025/iberia/SS3";
import finalResult from "@/data/constants/WRC/brc/2025/iberia/finalResult";
...
import SS4 from "@/data/constants/WRC/brc/2025/iberia/SS4";
import SS5 from "@/data/constants/WRC/brc/2025/iberia/SS5";
import SS6 from "@/data/constants/WRC/brc/2025/iberia/SS6";
import SS7 from "@/data/constants/WRC/brc/2025/iberia/SS7";
import SS8 from "@/data/constants/WRC/brc/2025/iberia/SS8";
import SS9 from "@/data/constants/WRC/brc/2025/iberia/SS9";
import SS10 from "@/data/constants/WRC/brc/2025/iberia/SS10";
...
export default function IberiaPage() {
  ...
  const renderContent = () => {
    if (selectedOption === "Final") {
      ...
      return <TabelaDePontos results={tabelaIberia} />;
    } else {
      return (
        <TabelaWRC
