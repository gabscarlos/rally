...
import ss1 from "@/data/constants/WRC/brc/2025/centraleurope/SS1";
import ss2 from "@/data/constants/WRC/brc/2025/centraleurope/SS2";
import ss3 from "@/data/constants/WRC/brc/2025/centraleurope/SS3";
import finalResult from "@/data/constants/WRC/brc/2025/centraleurope/finalResult";
...
import SS4 from "@/data/constants/WRC/brc/2025/centraleurope/SS4";
import SS5 from "@/data/constants/WRC/brc/2025/centraleurope/SS5";
import SS6 from "@/data/constants/WRC/brc/2025/centraleurope/SS6";
import SS7 from "@/data/constants/WRC/brc/2025/centraleurope/SS7";
...
export default function GreecePage() {
  ...
  const renderContent = () => {
    if (selectedOption === "Final") {
      ...
      return <TabelaDePontos results={tabelaCentralEurope} />;
    } else {
      return (
        <TabelaWRC
