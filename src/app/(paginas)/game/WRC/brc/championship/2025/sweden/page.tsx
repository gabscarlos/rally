...
import ss1 from "@/data/constants/WRC/brc/2025/sweden/SS1";
import ss2 from "@/data/constants/WRC/brc/2025/sweden/SS2";
import ss3 from "@/data/constants/WRC/brc/2025/sweden/SS3";
import finalResult from "@/data/constants/WRC/brc/2025/sweden/finalResult";
...
import SS4 from "@/data/constants/WRC/brc/2025/sweden/SS4";
import SS5 from "@/data/constants/WRC/brc/2025/sweden/SS5";
import SS6 from "@/data/constants/WRC/brc/2025/sweden/SS6";
import SS7 from "@/data/constants/WRC/brc/2025/sweden/SS7";
import SS8 from "@/data/constants/WRC/brc/2025/sweden/SS8";
import SS9 from "@/data/constants/WRC/brc/2025/sweden/SS9";
import SS10 from "@/data/constants/WRC/brc/2025/sweden/SS10";
...
export default function SwedenPage() {
  ...
  const renderContent = () => {
    if (selectedOption === "Final") {
      ...
      return <TabelaDePontos results={tabelaSweden} />;
    } else {
      return (
        <TabelaWRC
