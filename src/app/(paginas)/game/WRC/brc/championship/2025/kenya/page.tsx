...
import ss1 from "@/data/constants/WRC/brc/2025/kenya/SS1";
import ss2 from "@/data/constants/WRC/brc/2025/kenya/SS2";
import ss3 from "@/data/constants/WRC/brc/2025/kenya/SS3";
import finalResult from "@/data/constants/WRC/brc/2025/kenya/finalResult";
...
import SS4 from "@/data/constants/WRC/brc/2025/kenya/SS4";
import SS5 from "@/data/constants/WRC/brc/2025/kenya/SS5";
import SS6 from "@/data/constants/WRC/brc/2025/kenya/SS6";
import SS7 from "@/data/constants/WRC/brc/2025/kenya/SS7";
import SS8 from "@/data/constants/WRC/brc/2025/kenya/SS8";
import SS9 from "@/data/constants/WRC/brc/2025/kenya/SS9";
import SS10 from "@/data/constants/WRC/brc/2025/kenya/SS10";
...
export default function SwedenPage() {
  ...
  const renderContent = () => {
    if (selectedOption === "Final") {
      ...
      return <TabelaDePontos results={tabelaKenya} />;
    } else {
      return (
        <TabelaWRC
