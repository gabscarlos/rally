...
import ss1 from "@/data/constants/WRC/brc/2025/pacifico/SS1";
import ss2 from "@/data/constants/WRC/brc/2025/pacifico/SS2";
import ss3 from "@/data/constants/WRC/brc/2025/pacifico/SS3";
import finalResult from "@/data/constants/WRC/brc/2025/pacifico/finalResult";
...
import SS4 from "@/data/constants/WRC/brc/2025/pacifico/SS4";
import SS5 from "@/data/constants/WRC/brc/2025/pacifico/SS5";
import SS6 from "@/data/constants/WRC/brc/2025/pacifico/SS6";
import SS7 from "@/data/constants/WRC/brc/2025/pacifico/SS7";
import SS8 from "@/data/constants/WRC/brc/2025/pacifico/SS8";
import SS9 from "@/data/constants/WRC/brc/2025/pacifico/SS9";
import SS10 from "@/data/constants/WRC/brc/2025/pacifico/SS10";
...
export default function GreecePage() {
  ...
  const renderContent = () => {
    if (selectedOption === "Final") {
      ...
      return <TabelaDePontos results={tabelaPacifico} />;
    } else {
      return (
        <TabelaWRC
