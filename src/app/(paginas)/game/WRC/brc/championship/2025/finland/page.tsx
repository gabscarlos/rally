...
import ss1 from "@/data/constants/WRC/brc/2025/finland/SS1";
import ss2 from "@/data/constants/WRC/brc/2025/finland/SS2";
import ss3 from "@/data/constants/WRC/brc/2025/finland/SS3";
import finalResult from "@/data/constants/WRC/brc/2025/finland/finalResult";
...
import SS4 from "@/data/constants/WRC/brc/2025/finland/SS4";
import SS5 from "@/data/constants/WRC/brc/2025/finland/SS5";
import SS6 from "@/data/constants/WRC/brc/2025/finland/SS6";
import SS7 from "@/data/constants/WRC/brc/2025/finland/SS7";
import SS8 from "@/data/constants/WRC/brc/2025/finland/SS8";
import SS9 from "@/data/constants/WRC/brc/2025/finland/SS9";
import SS10 from "@/data/constants/WRC/brc/2025/finland/SS10";
...
export default function GreecePage() {
  ...
  const renderContent = () => {
    if (selectedOption === "Final") {
      ...
      return <TabelaDePontos results={tabelaFinland} />;
    } else {
      return (
        <TabelaWRC
